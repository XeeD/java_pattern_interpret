 ...
 * Copyright:    Copyright (c) 2001 by Rudolf PECINOVSKÝ<p>
...
//===== Nonstatic attributes ==================================================
    ...
    /**
     * If pocetZrychleni > 0, the robot will not wait before make next step or turn.
     */
...
//===== Constructors ==========================================================
     ...
     *  to the given smer dir. If there is no robot's world yet
    ...
    public Robot( int xr, int yr, int dirr, int colorr ) {
        ...
        delay     = 250;
        pocetZrychleni= 0;
        if( znacek == null ) pripravDvorek( 10, 10 );
        if( (xr     < 0)  ||  (xr    > xMax)   ||
            (yr     < 0)  ||  (yr    > yMax)   ||
...
//===== Public methods ========================================================
    ...
    public static void zmenDvorek( String[] layout ) {
        ...
        Robot r = robot[0][0];
        if( r != null )  RWindow.drawField( 0, 0, znacek[0][0] );
        try {
    ...
    public static int  getMaxZnacek() { return MAX_ZNACEK; }
    public static char getZnakZed()   { return RWindow.getWallChar(); }


    public int  getX ()        { return xpos; }
    public int  getY ()        { return ypos; }
    public int  getSmer()      { return smer; }
    public int  getBarva()     { return color; }
    public int  getCekani()    { return delay; }
     ...
     *
     */
    public boolean jeNasazen() { return vAkci; }
    ...
    public Robot robotPred() {
        return robot[xpos + INCREMENT[smer][0]]
                    [ypos + INCREMENT[smer][1]];
    }//public Robot robotPred()
     ...
     *  smer in whith it looks and number of markers on the field
     *  it is staing on.
     */
