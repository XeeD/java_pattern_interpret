...
/*******************************************************************************
 * Instance třídy {@code Překladač} přestavují lexikální a syntaktické
 * analyzátory, které převedou text do stromové struktury
 * vnitřní reprezentace programu.
 * Tato verze neodděluje čísla znakem
 * <p>
...
//== SOUKROMÉ A POMOCNÉ METODY TŘÍDY ===========================================
    ...
    private static IAritmVýraz přeložSoučet( Zdroj zdroj )
    {
        ...
        if( zdroj.naŘadě == '+' ) {
            ...
            součet = new Mínus( součet, přeložSoučin( zdroj ) );
        }
        return součet;
    }
    ...
    private static IAritmVýraz přeložSoučin( Zdroj zdroj )
    {
        ...
        if( zdroj.naŘadě == '*' ) {
            ...
            součin = new Děl( součin, přeložČlen( zdroj ) );
        }
        return součin;
    }
     ...
     *
     * @param zdroj Doposud nezpracovaný zdrojový text
     * @return Instance reprezentující zadanou konstantu
     */
     ...
     *
     * @param zdroj Doposud nezpracovaný zdrojový text
     * @return Instance reprezentující zadanou proměnnou
     */
    @SuppressWarnings("empty-statement")
...
//== VNOŘENÉ A VNITŘNÍ TŘÍDY ===================================================
    ...
    private static class Zdroj
    {
        ...
        /***********************************************************************
         * Vytvoří nový zdroj obsahující zadaný text.
         *
         * @param text Text, který bude překladač vyhodnocovat
         */
        Zdroj( String text )
        {
            this.text = text;
        ...
        /***********************************************************************
         * Vrátí část vstupu od zadané do aktuální pozice.
         *
         * @param start Pozice znaku v textu, od nějž chceme znát vstup
         * @return Část vstupu od zadané do aktuální pozice
         */
