...
/*******************************************************************************
 * Instance třídy Konjunkce přestavují konjunkci dvou výrazů (A a zároveň B).
 *
 * @author    Rudolf PECINOVSKÝ
 * @version   0.00.000,  4.10.2006
 */

public class Konjunkce implements LogickýVýraz
{
...
//== KONSTRUKTORY A TOVÁRNÍ METODY =============================================
    ...
    /***************************************************************************
     * Vytvoří nový výraz představující konjunkci zadaných výrazů
     * (A a zároveň B).
     *
     * @param levý  Levý operand
     * @param pravý Pravý operand
     */
    public Konjunkce( LogickýVýraz levý, LogickýVýraz pravý )
    {
        this.levý  = levý;
        this.pravý = pravý;
    }
    ...
    {
        return new Konjunkce( levý, pravý );
    }
    ...
    {
        return new Konjunkce( levý .nahraď( proměnná, výraz ),
